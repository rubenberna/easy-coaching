...
router.post('/get_user', async (req, res) => {
  ...
  const {id} = req.body
  const q = `SELECT Id, AccountId, Name, Email, Account.Name, Phone, MailingAddress, External_Id__c, Coaching_interventions__c, Frequentie__c FROM Contact WHERE External_Id__c = '${id}'`;
  try {
